   ...
   */
   ...
   private void add(Instruction _i){
      ...
      switch(_i.getByteCode()){
         ...
         case ALOAD_2:
         case ALOAD_3:
            add(new mov<ref>(_i, new StackReg_ref(_i, 0), new VarReg_ref(_i)));
            break;
         case IALOAD:{
         ...
         case ASTORE_2:
         case ASTORE_3:
            add(new mov<ref>(_i, new VarReg_ref(_i), new StackReg_ref(_i, 0)));
         ...
         case GETFIELD:{
            ...
            if(type.isArray()){
               add(new get_field<ref>(_i, new StackReg_ref(_i, 0)));
            }else if(type.isInt()){
         ...
         case PUTFIELD:{
            TypeHelper.JavaType type = _i.asFieldAccessor().getConstantPoolFieldEntry().getType();
            if(type.isArray()){
               add(new put_field<ref>(_i, new StackReg_ref(_i, 0)));
            }else if(type.isInt()){
