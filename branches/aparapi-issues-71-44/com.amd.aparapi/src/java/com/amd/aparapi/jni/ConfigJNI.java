...
public class ConfigJNI {
    ...
    */
   private boolean disableUnsafe = Boolean.getBoolean(propPkgName + ".disableUnsafe");
   ...
   /**
    * @return the disableUnsafe
    */
   public boolean isDisableUnsafe() {
      return disableUnsafe;
   }

   /**
    * @param disableUnsafe the disableUnsafe to set
    */
   public void setDisableUnsafe(boolean disableUnsafe) {
