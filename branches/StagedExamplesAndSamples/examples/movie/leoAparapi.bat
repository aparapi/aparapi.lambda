...
java -Dcom.amd.aparapi.enableProfiling=false  -classpath jjmpeg\jjmpeg-0.0\dist\jjmpeg.jar;..\..\..\..\trunk\com.amd.aparapi\dist\aparapi.jar;movie.jar;..\jviolajones\jvj.jar;..\jviolajones\jdom.jar com.amd.aparapi.sample.jjmpeg.Main
